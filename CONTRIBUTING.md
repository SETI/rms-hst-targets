# Contributing to rms-hst-targets

Thank you for your interest in contributing to rms-hst-targets! This document provides guidelines and instructions for contributing to the project.
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/rms-hst-targets.git
   cd rms-hst-targets
   ```
...
Thank you for contributing to rms-hst-targets!
