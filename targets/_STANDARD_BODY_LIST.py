...
_STANDARD_BODY_LIST = [
    ...
    ('Isonoe'     , 26,   526, 'S', 'Jupiter', ['S/2000 J 6' ]),
    ...
    ('Herse'      , 50,   550, 'S', 'Jupiter', ['S/2003 J 17']),
    (''           , 51,   551, 'S', 'Jupiter', ['S/2010 J 1' ]),
    (''           , 52,   552, 'S', 'Jupiter', ['S/2010 J 2' ]),
    ('Dia'        , 53,   553, 'S', 'Jupiter', ['S/2000 J 11']),
    (''           , 54,   554, 'S', 'Jupiter', ['S/2016 J 1' ]),
    (''           , 55,   555, 'S', 'Jupiter', ['S/2003 J 18']),
    (''           , 56,   556, 'S', 'Jupiter', ['S/2011 J 2' ]),
    ('Eirene'     , 57,   557, 'S', 'Jupiter', ['S/2003 J 5' ]),
    ('Philophrosyne', 58, 558, 'S', 'Jupiter', ['S/2003 J 15']),
    (''           , 59,   559, 'S', 'Jupiter', ['S/2017 J 1' ]),
    ('Eupheme'    , 60,   560, 'S', 'Jupiter', ['S/2003 J 3' ]),
    (''           , 61,   561, 'S', 'Jupiter', ['S/2003 J 19']),
    ('Valetudo'   , 62,   562, 'S', 'Jupiter', ['S/2016 J 2' ]),
    (''           , 63,   563, 'S', 'Jupiter', ['S/2017 J 2' ]),
    (''           , 64,   564, 'S', 'Jupiter', ['S/2017 J 3' ]),
    ('Pandia'     , 65,   565, 'S', 'Jupiter', ['S/2017 J 4' ]),
    (''           , 66,   566, 'S', 'Jupiter', ['S/2017 J 5' ]),
    (''           , 67,   567, 'S', 'Jupiter', ['S/2017 J 6' ]),
    (''           , 68,   568, 'S', 'Jupiter', ['S/2017 J 7' ]),
    (''           , 69,   569, 'S', 'Jupiter', ['S/2017 J 8' ]),
    (''           , 70,   570, 'S', 'Jupiter', ['S/2017 J 9' ]),
    ('Ersa'       , 71,   571, 'S', 'Jupiter', ['S/2018 J 1' ]),
    (''           , 72,   572, 'S', 'Jupiter', ['S/2011 J 1' ]),
    (''           , 73,   573, 'S', 'Jupiter', ['S/2003 J 2' ]),
    ...
    ('Gridr'      , 54,   654, 'S', 'Saturn', ['S/2004 S 20']),
    ('Angrboda'   , 55,   655, 'S', 'Saturn', ['S/2004 S 22']),
    ('Skrymir'    , 56,   656, 'S', 'Saturn', ['S/2004 S 23']),
    ('Gerd'       , 57,   657, 'S', 'Saturn', ['S/2004 S 25']),
    (''           , 58,   658, 'S', 'Saturn', ['S/2004 S 26']),
    ('Eggther'    , 59,   659, 'S', 'Saturn', ['S/2004 S 27']),
    (''           , 60,   660, 'S', 'Saturn', ['S/2004 S 29']),
    ('Beli'       , 61,   661, 'S', 'Saturn', ['S/2004 S 30']),
    ('Gunnlod'    , 62,   662, 'S', 'Saturn', ['S/2004 S 32']),
    ('Thiazzi'    , 63,   663, 'S', 'Saturn', ['S/2004 S 33']),
    (''           , 64,   664, 'S', 'Saturn', ['S/2004 S 34']),
    ('Alvaldi'    , 65,   665, 'S', 'Saturn', ['S/2004 S 35']),
    ('Geirrod'    , 66,   666, 'S', 'Saturn', ['S/2004 S 38']),
    (''           , 67, 65085, 'S', 'Saturn', ['S/2004 S 7' ]),
    (''           ,  0, 65086, 'S', 'Saturn', ['S/2004 S 12']),
    (''           ,  0, 65087, 'S', 'Saturn', ['S/2004 S 13']),
    (''           ,  0, 65088, 'S', 'Saturn', ['S/2004 S 17']),
    (''           ,  0, 65089, 'S', 'Saturn', ['S/2006 S 1' ]),
    (''           ,  0, 65090, 'S', 'Saturn', ['S/2006 S 3' ]),
    (''           ,  0, 65091, 'S', 'Saturn', ['S/2007 S 2' ]),
    (''           ,  0,     0, 'S', 'Saturn', ['S/2007 S 3' ]),
